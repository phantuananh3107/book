...
<body>
              ...
              <?php
                  if(isset($_SESSION['user'])) {
                    ...
                    <li><a href="destroy.php" class="btn btn-md"><span class="glyphicon glyphicon-log-out">LogOut</span></a></li>';
                      ...
                      echo '<li><a href="index.php?Message=Login To Continue" class="btn btn-md"><span class="glyphicon glyphicon-log-in">Login</span></a></li>';
                  }
              ?>
          </ul>
        </div><!-- /.navbar-collapse -->
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" class="form-control" name="keyword" placeholder="Tìm kiếm" style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
    ...
    if(mysqli_num_rows($result) > 0) {   
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $add_to_cart = isset($_SESSION['user']) ? "cart.php?add=" . $row["PID"] : "index.php?Message=Login To Add To Cart";
            ...
            echo '
               <div class="col-sm-6 col-md-3 col-lg-3 text-center">
                   <div class="book-block" style="border:3px solid #DEEAEE;">
                       ...
                       <br>
                       <a href="' . $add_to_cart . '" class="btn btn-primary btn-sm" style="margin-top: 10px;">Thêm vào giỏ</a>
                   </div>
               </div>';
            $i++;
            if($i % 4 == 0) echo '</div>';
